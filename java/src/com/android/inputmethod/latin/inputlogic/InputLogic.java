    ...
    private void handleFunctionalEvent(final Event event, final InputTransaction inputTransaction,
        ...
        switch (event.mKeyCode) {
            ...
            case Constants.CODE_SHIFT_ENTER:
                ...
                inputTransaction.setDidAffectContents();
                break;
            case Constants.CODE_SPEAK_TO_TRANSLATE: {
                break;
            }
            default:
...
//        mLatinIME.switchToNextSubtype();
    ...
    public void switchLanguageKey() {
        boolean isLanguageSet = new KeyboardPreferences(mLatinIME).getLanguage();

        new KeyboardPreferences(mLatinIME).setLanguage(!isLanguageSet);

        mLatinIME.refreshKeyboardLayout();

...
public class MimeTypeUtil {
    ...
    public static final String MIME_START_WITH_IMAGE = "image/";
    public static final String MIME_GIF_IMAGE = "image/gif";
    public static final String MIME_START_WITH_AUDIO = "audio/";
    public static final String RECORD_AUDIO_FORMAT = "m4a";
    public static final String MIME_SVG = "svg";
    public static final String MIME_TIFF = "tiff";
    public static final String MIME_START_WITH_VIDEO = "video/";
    public static final String MIME_VCF = "vcf";

    public static final String KEY_DOC = "doc";
    public static final String KEY_DOCX = "docx";
    public static final String TEXT = "text/*";

    public static String getType(String filename) {
        if (types.size() == 0) init();
        return types.get(filename.toLowerCase());
    }

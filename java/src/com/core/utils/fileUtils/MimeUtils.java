...
import static com.core.utils.MimeTypeUtil.OCTET_STREAM;
...
public final class MimeUtils {
    ...
    static {
        ...
        add("application/vnd.conversations.backup", "ceb");
        ...
        add("application/vnd.microsoft.portable-executable", "exe");
        add("application/rtf", "rtf");
        add("application/x-ios-app", "ipa");
        applyOverrides();
    }
    ...
    public static String guessMimeTypeFromUriAndMime(final Context context, final Uri uri, final String mime) {
        if (mime == null || mime.equals(OCTET_STREAM)) {
    ...
    public static String guessMimeTypeFromUri(Context context, Uri uri) {
        ...
        // try the extension
        if (uri != null && (mimeType == null || mimeType.equals(OCTET_STREAM)) && uri.getPath() != null) {
    ...
    public static Boolean checkMimeStartWithAI(String mimeType) {
        return mimeType.startsWith(MimeTypeUtil.getType(MimeTypeUtil.KEY_PDF)) ||
                mimeType.startsWith(MimeTypeUtil.getType(MimeTypeUtil.KEY_DOC)) ||
                mimeType.startsWith(MimeTypeUtil.getType(MimeTypeUtil.KEY_DOCX)) ||
                mimeType.startsWith(MimeTypeUtil.TEXT);
    }
}
